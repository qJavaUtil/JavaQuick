...
public class ExecuteUtil {
     ...
     *
     * @return String
     * @see  @System.out.println(Charset.defaultCharset());<br>
     *      查看预置的变量信息:System.getProperties().list(System.out);<br>
     *      属性:<br>
     *      文件编码:file.encoding<br>
     *      系统默认编码sun.jnu.encoding<br>
    ...
    public static class CommandThread extends Thread {
        ...
        public CommandThread(PrintWriter writer) {
            this.writer = writer;
    ...
    public static class ProcessInputStreamThread extends Thread {

        InputStream input;
        BufferedReader breader = null;

        public ProcessInputStreamThread(InputStream input) {
            this.input = input;
            // 避免出现乱码问题,直接使用系统默认的编码格式
